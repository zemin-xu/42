...
void	check_strtrim(void)
{
	...
	printf("[-] str : %s || set: %s || res: %s || compare : %d[-]\n",
			s1, "  ", "(\"Bonjour\")", strcmp(ft_strtrim(s1, "  "), "(\"Bonjour\")")); 
	printf("[-] str : %s || set: %s || res: %s || compare : %d[-]\n",
			s2, "  ", "Bonjour", strcmp(ft_strtrim(s2, "  "), "Bonjour")); 
	printf("[-] str : %s || set: %s || res: %s || compare : %d[-]\n",
			s3, " ", "Bonjour", strcmp(ft_strtrim(s3, " "), "Bonjour")); 
	printf("[-] str : %s || set: %s || res: %s || compare : %d[-]\n",
			s4, "", "    Bonjour", strcmp(ft_strtrim(s4, ""), "     Bonjour")); 
	printf("[-] str : %s || set: %s || res: %s || compare : %d[-]\n",
			s5, "$$", "", strcmp(ft_strtrim(s5, "$$"), "")); 
	printf("[-] str : %s || set: %s || res: %s || compare : %d[-]\n",
			s5, "", "", strcmp(ft_strtrim(s5, ""), "")); 
	printf("[-] str : %s || set: %s || res: %s || compare : %d[-]\n",
			s6, " ", "", strcmp(ft_strtrim(s6, " "), "")); 
	printf("[-] str : %s || set: %s || res: %s || compare : %d[-]\n",
			s1, " ()\"", "Bonjour", strcmp(ft_strtrim(s1, " ()\""), "Bonjour")); 
	printf("[-] str : %s || set: %s || res: %s || compare : %d[-]\n",
			s3, "Bo", "njour     ", strcmp(ft_strtrim(s3, "Bo"), "njour     ")); 
	printf("[-] str : %s || set: %s || res: %s || compare : %d[-]\n",
			s7, " ", "A", strcmp(ft_strtrim(s7, " "), "A")); 
	printf("[-] str : %s || set: %s || res: %s || compare : %d[-]\n",
			s8, " ", "A", strcmp(ft_strtrim(s8, " "), "A")); 
	printf("[-] str : %s || set: %s || res: %s || compare : %d[-]\n",
			s9, ".", "la.lou.li", strcmp(ft_strtrim(s9, "."), "la.lou.li")); 

	printf("[-] Test with EMPTY STRING [-]\n");
	printf("[-] str : %s || set: %s || res: %s || compare : %s[-]\n",
			NULL, " ", NULL, (ft_strtrim(NULL, " "))); 
	printf("[-] str : %s || set: %s || res: %s || compare : %s[-]\n",
			"BONJOUR", NULL, "BONJOUR", (ft_strtrim("BONJOUR", NULL))); 
	printf("[-] str : %s || set: %s || res: %s || compare : %s[-]\n",
			NULL, NULL, NULL, (ft_strtrim(NULL, NULL))); 
	printf("[-] str : %s || set: %s || res: %s || compare : %d[-]\n",
